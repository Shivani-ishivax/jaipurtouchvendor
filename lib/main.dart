...
Future<void> main() async {
  ...
  //   orderID = (notificationAppLaunchDetails!.payload. != null && notificationAppLaunchDetails.)
  ...
  if (notificationAppLaunchDetails?.didNotificationLaunchApp ?? false) {
    orderID = notificationAppLaunchDetails!.notificationResponse?.payload != null
        ? int.parse(notificationAppLaunchDetails.notificationResponse!.payload.toString())
        : null;
  }
